...
| 2 | **수업 자료 기반 응답** | 질문 + RAG 검색 결과 | 근거 있으면 자료 기반 답변, 없으면 "자료 기준 불확실" 표시 |
| 3 | **힌트형 응답** | 질문 + 의도 + RAG | 1단계 힌트→2단계 개념→3단계 유사문항→마지막 정답 검토 |
...
| 레이어 | 기술 | 비고 |
|--------|------|------|
| 프론트 | Next.js 16 + TypeScript | App Router, Server Components |
