...
pitch: "교사의 수업자료에 근거해 학생의 막힘 지점을 힌트 중심으로 해결하고, 교사에게는 오개념 heatmap과 즉시 개입용 보충과제를 제공하는 수업 후 보충 AI 코치."
---
...
2. **정답 직출 금지, 힌트 사다리** — 1단계 힌트→2단계 개념→3단계 유사문항→마지막 정답 검토
...
> **수학 과목 중심**. 향후 국어/영어/과학 확장 고려하되, 현재 버전은 수학 질문 흐름에 최적화.
...
**UI:** 매 질문에 접이식 "추천 보기" 버튼 (Collapsible)
...
| 심사 기준 | 대응 기능 | 어필 포인트 |
|----------|----------|------------|
| **기술적 완성도** | 수업자료 업로드, 질문 처리, RAG 응답, 대시보드 | end-to-end 작동 데모 |
| **AI 활용 능력** | 질문 의도 분류, 힌트형 응답, 오개념 클러스터링, 자료 기반 응답 | 4가지 AI 역할 명확 분리 |
| **기획력·실무 접합성** | 학생 막힘 해소, 교사 반복설명 감소, 수업 후 보충 개입 | AIDT 보완재 포지셔닝 |
| **창의성** | "정답 챗봇"이 아닌 "힌트형 AI 코치 + 오개념 대시보드" | 콴다의 안티테제 |
