...
| 04/06 (일) | D-6 | DB + 인증 + 레이아웃 | ✅ 완료 | Supabase 6테이블 + RLS + 역할 선택 UI + 공통 레이아웃 |
...
| 04/09 (수) | D-3 | 교사 대시보드 | ⬜ 대기 | 오개념 히트맵, 질문 로그, TOP 5 시각화 |
| 04/10 (목) | D-2 | 통합 + 시연 흐름 | ⬜ 대기 | end-to-end 데모 흐름, 버그 수정, UI 폴리시 |
| 04/11 (금) | D-1 | 배포 + 제출 준비 | ⬜ 대기 | Vercel 배포, AI 리포트 작성, README |
